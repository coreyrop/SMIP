...
sample_lesson = Lesson('Lesson 1: Register Addition'," Use the \'add\' instruction to set\n $t0 to 3,$t1 to 5,\n and then their sum in $t2.",
               ...
               " which are comma separated.", "Hint2", "Hint3"], ({'Name': "Green Sheet",'Type': "local_file",'Path': "MIPS_Green_Sheet.pdf"},{'Name':"Test Link", 'Type':"web_link", 'Path':"https://en.wikipedia.org/wiki/MIPS_architecture"}) , get_text())
